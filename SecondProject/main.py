...
async def setup_bot_commands():
    ...
    """
    bot_commands = [
        BotCommand(command="/start", description="Запустить бота и приветственное сообщение."),
        BotCommand(command="/myprofile", description="Обновить данные профиля."),
        BotCommand(command="/editprofile", description="Заполнить анкету знакомств заново."),
        BotCommand(command="/help", description="Если у тебя есть вопросы по интерфейсу бота.")
    ]
