import os
import random
from .VigenereFunctions import VigenereFunctions

kMinChar = 97 # 'a' in ASCII
kAlphSize = 26 # English alphabet size

class VigenereRequests():
    ...
    def first_request(self, input_file, key_file, output_file): # encrypt
        """
        ...
        if key_file == '-':
            key = self.key_generator(len(text))
    ...
    def second_request(self, input_file, key_file, output_file): # decrypt
        """
